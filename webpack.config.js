    ...
    */
    ...
    module: {
        rules: [
            ...
            {
                test: /\.(png|svg|jpg|gif|ico)$/, // Evalúa las extensiones permitidas para las imágenes por medio de una expresión regular
                use: [
                    {
    ...
    plugins: [
        ...
        new FaviconsWebpackPlugin('./src/assets/todoList.ico')
    ]
};
